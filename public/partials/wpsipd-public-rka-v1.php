...
foreach ($bl as $k => $sub_bl) {
	...
	$rinc = $wpdb->get_results("
		...
		Order by subs_bl_teks, ket_bl_teks, kode_akun ASC"
	, ARRAY_A);
	$rin_sub_item = '';
	$total_sub_rinc = 0;
	$akun = array();
	...
	foreach ($rinc as $key => $item) {
		if(empty($akun[$item['subs_bl_teks']])){
			$akun[$item['subs_bl_teks']] = array(
				'total' => 0,
				'status' => 0,
				'kode_akun' => '&nbsp;',
		...
		if(empty($akun[$item['subs_bl_teks']][$item['ket_bl_teks']])){
			$akun[$item['subs_bl_teks']][$item['ket_bl_teks']] = array(
				'total' => 0,
				'status' => 0,
				'kode_akun' => '&nbsp;',
		...
		, ARRAY_A);
		if(empty($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']])){
			$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']] = array(
				'total' => 0,
				'status' => 0,
		...
		if(empty($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']])){
			$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']] = array(
				'total' => 0,
				'status' => 0,
		...
		if(empty($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']])){
			$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']] = array(
				'total' => 0,
				'status' => 0,
		...
		if(empty($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']])){
			$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']] = array(
				'total' => 0,
				'status' => 0,
		...
		if(empty($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']][$item['nama_akun']])){
			$nama_akun = str_replace($item['kode_akun'], '', $item['nama_akun']);
			$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']][$item['nama_akun']] = array(
				'total' => 0,
				'status' => 0,
		...
		$akun[$item['subs_bl_teks']]['total'] += $item['total_harga'];
		$akun[$item['subs_bl_teks']][$item['ket_bl_teks']]['total'] += $item['total_harga'];
		$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']]['total'] += $item['total_harga'];
		$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']]['total'] += $item['total_harga'];
		$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']]['total'] += $item['total_harga'];
		$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']]['total'] += $item['total_harga'];
		$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']][$item['nama_akun']]['total'] += $item['total_harga'];
	}
	// print_r($akun); die();
	foreach ($rinc as $key => $item) {
		$akun_all = explode('.', $item['kode_akun']);
		...
		$akun_4_db = $wpdb->get_results("
			...
			where kode_akun='".$akun_4."'"
		, ARRAY_A);
		if($akun[$item['subs_bl_teks']]['status'] == 0){
			$akun[$item['subs_bl_teks']]['status'] = 1;
			$rin_sub_item .= '
				<tr>
		...
		if($akun[$item['subs_bl_teks']][$item['ket_bl_teks']]['status'] == 0){
			$akun[$item['subs_bl_teks']][$item['ket_bl_teks']]['status'] = 1;
			$rin_sub_item .= '
				<tr>
		...
		// if($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']]['status'] == 0){
		// 	$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']]['status'] = 1;
		// 	$rin_sub_item .= '
		// 		<tr>
	    //             <td class="kiri kanan bawah text_blok">'.$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']]['kode_akun'].'</td>
        //             <td class="kanan bawah text_blok" colspan="5">'.$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']]['nama_akun'].'</td>
        //             <td class="kanan bawah text_kanan text_blok" style="white-space:nowrap">Rp. '.number_format($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']]['total'],2,",",".").'</td>
        //         </tr>
		// 	';
		// }
		// if($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']]['status'] == 0){
		// 	$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']]['status'] = 1;
		// 	$rin_sub_item .= '
		// 		<tr>
	    //             <td class="kiri kanan bawah text_blok">'.$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']]['kode_akun'].'</td>
        //             <td class="kanan bawah text_blok" colspan="5">'.$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']]['nama_akun'].'</td>
        //             <td class="kanan bawah text_kanan text_blok" style="white-space:nowrap">Rp. '.number_format($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']]['total'],2,",",".").'</td>
        //         </tr>
		// 	';
		// }
		// if($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']]['status'] == 0){
		// 	$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']]['status'] = 1;
		// 	$rin_sub_item .= '
		// 		<tr>
	    //             <td class="kiri kanan bawah text_blok">'.$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']]['kode_akun'].'</td>
        //             <td class="kanan bawah text_blok" colspan="5">'.$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']]['nama_akun'].'</td>
        //             <td class="kanan bawah text_kanan text_blok" style="white-space:nowrap">Rp. '.number_format($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']]['total'],2,",",".").'</td>
        //         </tr>
		// 	';
		// }
		// if($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']]['status'] == 0){
		// 	$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']]['status'] = 1;
		// 	$rin_sub_item .= '
		// 		<tr>
	    //             <td class="kiri kanan bawah text_blok">'.$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']]['kode_akun'].'</td>
        //             <td class="kanan bawah text_blok" colspan="5">'.$akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']]['nama_akun'].'</td>
        //             <td class="kanan bawah text_kanan text_blok" style="white-space:nowrap">Rp. '.number_format($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']]['total'],2,",",".").'</td>
        //         </tr>
		// 	';
		// }
		...
		if($akun[$item['subs_bl_teks']][$item['ket_bl_teks']][$akun_1_db[0]['kode_akun']][$akun_2_db[0]['kode_akun']][$akun_3_db[0]['kode_akun']][$akun_4_db[0]['kode_akun']][$item['nama_akun']]['status'] == 0){
